...
\item L'archive banque.certif.tgz qui a \'et\'e d\'elivr\'e par la banque, pour que le client ai les coordon\'e banquaire du vendeur.
\end{itemize}
...
\begin{itemize}
\item Le cheque en clair (qui mentionne en 3 lignes: le rib du client, le montant et le N° de facture)
\item Le hash\'e-chiffr\'e du cheque
\item L'archive banque.certif.tgz qui a \'et\'e d\'elivr\'e par la banque, pour que le vendeur ai les coordon\'e banquaire du client.
\end{itemize}
